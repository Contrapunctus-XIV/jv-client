...
export const EDIT_ACCOUNT_URL = "https://www.jeuxvideo.com/sso/infos_pseudo.php";
export const TOPIC_TEST_URL = "https://www.jeuxvideo.com/forums/42-5100-76148254-1-0-1-0-test.htm";
...
export const SELECTORS = {
    ...
    "editProfileForm": "#page-compte form",
    "editProfileInputs": "input",
    "jvEditor": ".jv-editor"
};
